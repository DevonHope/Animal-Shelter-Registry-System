...
* Same thing for clients, it will create a folder (Clients) in the current directory. Then it will add the 5 client files in the 'Clients' folder
* There will be two buttons near the top called Client and Staff. Pressing either of those two enables you specific user privellages for those types of users such as clients can't add anything, but staff can do just about everything else
...
* Everytime you add or delete an animal and client, hit their respective refresh buttons to reflect the changes
