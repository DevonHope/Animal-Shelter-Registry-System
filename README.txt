...
* There will be a button called Staff and a drop down menu listing all the stored clients near the top of the main interface. Pressing the Staff button and choosing one of the clients enables you specific user privellages for those types of users, such as clients can only view all animal profiles and edit their own profile while staff can do just about anything except for editing the client profiles
